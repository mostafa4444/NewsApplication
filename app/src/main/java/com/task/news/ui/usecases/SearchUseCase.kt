...
class SearchUseCase @Inject constructor(dataRepository: DataRepository): BaseUseCase<HeadlineResponse>(dataRepository) {

    override suspend fun executeOnBackground(map: MutableMap<String, Any>, headerMap: MutableMap<String, String>): HeadlineResponse {
        return dataRepository.searchNews(headerMap, map)
    }
